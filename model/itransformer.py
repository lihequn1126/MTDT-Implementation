...
parser.add_argument('--output_dir', type=str, default=r"../result/hanyuan_itransformer", help='Output directory')
...
class Model(nn.Module):
    ...
    def forward(self, x_hist, x_fut_nwp):
        ...
        if self.use_norm:
            target_mean = means[:, 0, -1].unsqueeze(1).repeat(1, self.pred_len) 
            target_stdev = stdev[:, 0, -1].unsqueeze(1).repeat(1, self.pred_len) 
